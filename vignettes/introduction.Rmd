...
All the other columns included in loss data provide some type of description of the claim (e.g. claimant name, whether the claim is open or closed, etc.).  I refer to all of these columns as "description" columns.  There can be any number of description columns and `lossdb` does not consider any logical way to group them.

`lossdb` is designed to utilize the fundamental underlayings of loss data to make to make it easier to work with. 
