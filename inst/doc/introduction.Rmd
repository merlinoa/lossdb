...
* origin - the accident period or policy period in which the loss originated
* dev - the development stage of the loss
* id - a identifier for the loss (it should be unique by dev period)
